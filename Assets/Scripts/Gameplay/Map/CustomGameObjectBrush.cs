...
namespace UnityEditor.Tilemaps
{
    ...
    [CustomGridBrush(true, false, false, "Custom GameObject Brush")]
    public class CustomGameObjectBrush : GridBrushBase
    {
        ...
        private static void SetSceneCell(GridLayout grid, Transform parent, Vector3Int position, GameObject go, Vector3 offset, Vector3 scale, Quaternion orientation, Vector3 anchor)
        {
            ...
            HexaComponent hexa;
            if (instance.TryGetComponent(out hexa))
            {
                hexa.SetDefault();
            }
    ...
    public class CustomGameObjectBrushEditor : GridBrushEditorBase
    {
        ...
        /// </summary>
        public CustomGameObjectBrush brush { get { return target as CustomGameObjectBrush; } }
        ...
        public void OnPaintSceneGUI(GridLayout gridLayout, GameObject brushTarget, BoundsInt position, GridBrushBase.Tool tool, bool executing)
        {
