...
public class PrototypeNetworkManager : NetworkManager
{
    // Overrides the base singleton so we don't
    // have to cast to this type everywhere.
    public static new PrototypeNetworkManager singleton { get; private set; }
    ...
    public override void OnServerChangeScene(string newSceneName) {
        HCDebug.Log("Server Scene Change");
    }
    ...
    public void ChangeSceneForPlayers(List<NetworkConnectionToClient> connections, string newSceneName)
    {
        ...
        foreach (NetworkConnectionToClient conn in connections)
        {
            ...
            HCDebug.Log("Set not ready for client with connectionID:" + conn.connectionId);
        }
        ...
        if (NetworkServer.active)
        {
            ...
            NetworkServer.SendToAllInList(connections, new SceneMessage
            {
    ...
    //void SendToClientSceneMessage(int connectionId, SceneMessage message)
    //{
