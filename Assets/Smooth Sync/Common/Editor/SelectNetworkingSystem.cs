...
namespace Smooth
{
    ...
    {
        enum NetworkingSystem { UNET, MIRROR, MLAPI, NETCODE_FOR_GAMEOBJECTS, PUN, PUN2, FISH_NET, NONE }
        string[] networkingSystemStrings = { "UNet", "Mirror", "MLAPI", "Netcode for GameObjects", "PUN", "PUN2", "Fish Net", "None" };
        string[] packageStrings = { "UNet", "Mirror", "MLAPI", "NetcodeForGameObjects", "PUN", "PUN2", "FishNet", "None" };
        string[] inconsistentlyNamedExampleScenes = { "SmoothSyncExample", "SmoothSyncMirrorExample", "SmoothSyncMLAPIExample", "SmoothSyncNetcodeExample", "SmoothSyncExamplePUN", "SmoothSyncExampleScenePUN2", "Smooth Sync FishNet Example" };
        ...
        public static void SetNetworkingSystem()
        {
            ...
            window.minSize = new Vector2(820, 430);
            window.maxSize = new Vector2(820, 430);
            window.Show();
        }
